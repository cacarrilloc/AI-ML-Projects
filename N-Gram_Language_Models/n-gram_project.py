...
Original file is located at
    https://colab.research.google.com/drive/1MarCJgX7pmWUM5volEJleUJx5m3wnu0O
...
# https://drive.google.com/file/d/19ZFc_nFF3T-LTI9rxXUy1XyMaoGSzN3T/view?usp=share_link
!gdown 19ZFc_nFF3T-LTI9rxXUy1XyMaoGSzN3T
!unzip - o cities_train.zip
# https://drive.google.com/file/d/1BH9qhvR7POqmGPOPadqADv-NxdGBgyzu/view?usp=sharing
!gdown 1BH9qhvR7POqmGPOPadqADv-NxdGBgyzu
!unzip - o cities_val.zip
# https://drive.google.com/file/d/1mz6EdH-4pOwr-o3lHDlh1SS7oRdydNr1/view?usp=sharing
!gdown 1mz6EdH-4pOwr-o3lHDlh1SS7oRdydNr1
# https://drive.google.com/file/d/11es6r9fVz_wf_Q2T7oP2IQDkAAmhtzf4/view?usp=share_link
!gdown 11es6r9fVz_wf_Q2T7oP2IQDkAAmhtzf4
# https://drive.google.com/file/d/19P37gR_XDup-h3a4LdKtQWbdM-lGPqin/view?usp=sharing
!gdown 19P37gR_XDup-h3a4LdKtQWbdM-lGPqin
# https://drive.google.com/file/d/1kKfh2oaxinBPVwWaux6FA9TerqAH5nHw/view?usp=sharing
!gdown 1kKfh2oaxinBPVwWaux6FA9TerqAH5nHw
...
class NgramModel(object):
    ...
    def update(self, text):
        ...
        for i in range(len(text)):
            ...
            self.contexts[context]['chars'][char] = self.contexts[context]['chars'].get(
                char, 0) + 1
...
"""- **Answer 2.3**: Experiment with a few different lambdas and values of k and discuss the effects of smoothing and interpolation
in terms of perplexity. Alternatively, you can also try different number of n. You may still use text files from 2.2. [6 points]"""
...
for k in k_values:
    ...
    model.update("shakespeare_input.txt")
    # add-k smoothing acts as unsmoothed for small k
    uninterpolated = model.perplexity("shakespeare_sonnets.txt")
...
for file in os.listdir(train_dir):
    if file.endswith(".txt"):
        ...
        model = create_ngram_model_lines(
            NgramModelWithInterpolation, train_dir/file, n=n, k=k)
        model.set_lambdas(lambdas)
    ...
    if file.endswith(".txt"):
        ...
        with open(val_dir / file, encoding='utf-8') as f:
            for line in f:
                ...
                if not city:
                    continue
                perplexities = {code: model.perplexity(
                    city) for code, model in final_models.items()}
                predicted = min(perplexities, key=perplexities.get)
...
df_misclassified = pd.DataFrame(
    misclassified, columns=[" City Name ", " True Label ", " Predicted Label "])
...
print("\ntest_labels.txt has been generated with",
      len(test_labels), "predictions.")
